IF OBJECT_ID (N'dbo.SP_ADMIM_INSERT_MENU', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_ADMIM_INSERT_MENU
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_ADMIM_INSERT_MENU]
...
BEGIN
    ...
    INSERT INTO [ACube].[dbo].[ADMIN_MENU_MST]
           ([MENU_TITLE]
           ,[PARENT_MENU_SEQ]
           ,[DEPTH]
           ,[SORT_NUM]
