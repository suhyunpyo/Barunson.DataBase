IF OBJECT_ID (N'dbo.SP_ADMIN_SELECT_COMMON_CODE_LIST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_ADMIN_SELECT_COMMON_CODE_LIST
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_ADMIN_SELECT_COMMON_CODE_LIST]
