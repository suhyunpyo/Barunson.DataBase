IF OBJECT_ID (N'dbo.SP_ADMIN_SELECT_CART_LIST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_ADMIN_SELECT_CART_LIST
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_ADMIN_SELECT_CART_LIST]
	-- Add the parameters for the stored procedure here
	@p_shipping_date datetime
AS
BEGIN
	...
	WHERE CM.REQUEST_SHIPPING_DATE = @p_shipping_date
