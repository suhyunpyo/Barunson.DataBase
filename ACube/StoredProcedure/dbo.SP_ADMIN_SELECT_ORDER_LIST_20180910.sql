IF OBJECT_ID (N'dbo.SP_ADMIN_SELECT_ORDER_LIST_20180910', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_ADMIN_SELECT_ORDER_LIST_20180910
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_ADMIN_SELECT_ORDER_LIST_20180910]
...
BEGIN
    ...
    SET @r_total_count = (
					...
					(
						...
						AND (
							CASE @p_cart_type 
							WHEN '' THEN @p_cart_type
							ELSE CM.CART_TYPE_CODE  END
						) = @p_cart_type
