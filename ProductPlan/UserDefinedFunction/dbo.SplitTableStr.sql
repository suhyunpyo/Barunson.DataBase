...
GO
/****** Object:  UserDefinedFunction [dbo].[SplitTableStr]    Script Date: 2021-05-25 오전 9:40:56 ******/

CREATE FUNCTION [dbo].[SplitTableStr]
(   
   @vcList NVARCHAR(MAX),
   @vcDelimiter    NVARCHAR(2)
)
RETURNS @Arrary TABLE (IndexNo int identity, Value NVARCHAR(500), PRIMARY KEY (IndexNo))
