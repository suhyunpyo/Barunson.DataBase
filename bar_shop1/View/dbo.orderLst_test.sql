IF OBJECT_ID (N'dbo.orderLst_test', N'V') IS NOT NULL DROP View dbo.orderLst_test
GO
...
SELECT   A.order_seq, A.order_type, A.isChoanRisk, A.isSpecial, A.sales_Gubun, 
                ...
                A.src_print_date, A.src_printCopy_date, A.src_jebon_date, A.src_packing_date, 
                A.src_send_date, A.order_name, A.settle_status, A.isinpaper, A.ishandmade, 
                A.fticket_price, A.mini_price, A.isCompose, A.isChoanRisk AS Expr1, A.ProcLevel, 
                A.couponseq, D.CARD_CODE, A.order_count, A.order_price, ISNULL(A.settle_price, 
                0) AS settle_price, A.last_total_price, 
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'orderLst_test'
GO
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'orderLst_test'
GO
