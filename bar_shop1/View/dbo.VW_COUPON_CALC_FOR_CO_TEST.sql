IF OBJECT_ID (N'dbo.VW_COUPON_CALC_FOR_CO_TEST', N'V') IS NOT NULL DROP View dbo.VW_COUPON_CALC_FOR_CO_TEST
GO
...
GO
CREATE VIEW [dbo].[VW_COUPON_CALC_FOR_CO_TEST]    
AS    
SELECT  ORDER_SEQ
        , UP_ORDER_SEQ
        , UID
...
FROM     (
        ...
        CA_CARD.CARD_SEQ IS NOT NULL AND CA_CARD.CARD_ALLOW_YN = 'Y' AND CO.card_seq = CA_CARD.CARD_SEQ OR  
          ...
          AND (CO.sales_Gubun = 'SB' AND   
                               ...
                               CO.order_count >= CM.ORDER_CNT) 
							   
							   --AND (CM.ORDER_APPLY_TYPE = 'ALL' OR  
