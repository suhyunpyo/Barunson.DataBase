IF OBJECT_ID (N'dbo.fn_PrintDate', N'FN') IS NOT NULL OR 
	OBJECT_ID (N'dbo.fn_PrintDate', N'FS') IS NOT NULL OR 
	OBJECT_ID (N'dbo.fn_PrintDate', N'FT') IS NOT NULL OR 
	OBJECT_ID (N'dbo.fn_PrintDate', N'IF') IS NOT NULL OR 
	OBJECT_ID (N'dbo.fn_PrintDate', N'TF') IS NOT NULL 
BEGIN
    DROP FUNCTION dbo.fn_PrintDate
END
GO
...
*/
CREATE FUNCTION [dbo].[fn_PrintDate]
(
