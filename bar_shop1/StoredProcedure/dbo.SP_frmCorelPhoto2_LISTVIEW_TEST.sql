IF OBJECT_ID (N'dbo.SP_frmCorelPhoto2_LISTVIEW_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_frmCorelPhoto2_LISTVIEW_TEST
GO
...
*/
CREATE PROCEDURE [dbo].[SP_frmCorelPhoto2_LISTVIEW_TEST]
