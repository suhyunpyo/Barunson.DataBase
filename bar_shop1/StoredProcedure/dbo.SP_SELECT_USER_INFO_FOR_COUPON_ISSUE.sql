IF OBJECT_ID (N'dbo.SP_SELECT_USER_INFO_FOR_COUPON_ISSUE', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_USER_INFO_FOR_COUPON_ISSUE
GO
...
EXEC SP_SELECT_USER_INFO_FOR_COUPON_ISSUE '', '', '', '', '', '', '', '', '', '', 'N', 0, 20, 1

*/

CREATE PROCEDURE [dbo].[SP_SELECT_USER_INFO_FOR_COUPON_ISSUE]
