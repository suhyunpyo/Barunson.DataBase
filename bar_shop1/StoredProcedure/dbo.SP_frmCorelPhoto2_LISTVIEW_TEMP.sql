IF OBJECT_ID (N'dbo.SP_frmCorelPhoto2_LISTVIEW_TEMP', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_frmCorelPhoto2_LISTVIEW_TEMP
GO
...
CREATE PROCEDURE [dbo].[SP_frmCorelPhoto2_LISTVIEW_TEMP]
