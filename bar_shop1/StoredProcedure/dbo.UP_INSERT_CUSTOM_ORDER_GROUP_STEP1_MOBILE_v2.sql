IF OBJECT_ID (N'dbo.UP_INSERT_CUSTOM_ORDER_GROUP_STEP1_MOBILE_v2', N'P') IS NOT NULL DROP PROCEDURE dbo.UP_INSERT_CUSTOM_ORDER_GROUP_STEP1_MOBILE_v2
GO
...
수정일		수정자		요청자		내용
----------------------------------------------------------*/
CREATE	PROC [dbo].[UP_INSERT_CUSTOM_ORDER_GROUP_STEP1_MOBILE_v2]
	@UID				AS VARCHAR(16),
