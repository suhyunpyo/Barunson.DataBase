IF OBJECT_ID (N'dbo.SP_CANCEL_MARKETING_AGREEMENT_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_CANCEL_MARKETING_AGREEMENT_TEST
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_CANCEL_MARKETING_AGREEMENT_TEST] 
