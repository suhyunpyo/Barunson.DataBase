IF OBJECT_ID (N'dbo.SP_GUEST_SAMPLE_CONVERSION_BHANDS', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_GUEST_SAMPLE_CONVERSION_BHANDS
GO
...
CREATE PROCEDURE [dbo].[SP_GUEST_SAMPLE_CONVERSION_BHANDS]
	@GUID 					            AS      VARCHAR(50) ,
	@UID								AS      VARCHAR(50) ,
	@COMPANY_SEQ						AS      INT
AS
