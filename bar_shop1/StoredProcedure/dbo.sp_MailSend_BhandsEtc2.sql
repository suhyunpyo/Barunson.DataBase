IF OBJECT_ID (N'dbo.sp_MailSend_BhandsEtc2', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_MailSend_BhandsEtc2
GO
...
CREATE  Proc [dbo].[sp_MailSend_BhandsEtc2]
as
...
'				<tr><td colspan="3"><img src="http://file.barunsoncard.com/ems/SA/new_top_02.jpg" width="666" height="177" border="0" usemap="#Map" /></td></tr>'+
'		<tr><td width="35" valign="top" background="http://file.barunsoncard.com/ems/SA/new_left_bg.jpg"><img src="http://file.barunsoncard.com/ems/SA/new_left_01.jpg" width="35" /></td><td width="575" valign="top">'+
'				<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td valign="top">'+
'					<table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td valign="middle" align="left" width="206"><br /><table cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-left:8px"><span style="font-size:18px;font-weight:bold;color:#F09;border-bottom:1px solid #666;vertical-align:middle">:::name:::</span> </td><td style="padding-left:5px;"><img src="http://file.barunsoncard.com/ems/SA/txt03_5.gif" alt="님"/></td></tr></table><p style="margin:0;padding:0;"><img src="http://file.barunsoncard.com/ems/SA/new_02_img_01.jpg" width="575" height="399" border="0" usemap="#Map2" /></p></td></tr></table></td></tr>'+
...
'<map name="Map2" id="Map2"><area shape="rect" coords="169,94,391,143" href="http://www.bhandscard.com" target="_blank"/></map>'+
'<map name="Map3" id="Map3"><area shape="rect" coords="12,58,144,95" href="http://www.bhandscard.com" target="_blank" /></map></body></html>'

	
	set @email_title = '샘플은 잘 받아보셨나요?'
...
------------------------------------------------------------------------------------------------------------
	...
	FOR 		
	select distinct A.MEMBER_NAME,A.member_email
	from custom_sample_order A left outer join custom_order B 
	on A.MEMBER_ID = B.MEMBER_ID and A.COMPANY_SEQ = B.company_seq and B.status_seq>=1
	where a.company_seq=5006 and A.STATUS_SEQ=12 and datediff(day,A.delivery_date,GETDATE())=7 and B.order_seq is null
	OPEN item_cursor
