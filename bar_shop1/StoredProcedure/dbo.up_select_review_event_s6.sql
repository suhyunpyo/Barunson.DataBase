IF OBJECT_ID (N'dbo.up_select_review_event_s6', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_review_event_s6
GO
...
-- EXEC up_select_review_event_s6 '5007','1','20','0','',''
-- =============================================
CREATE PROCEDURE [dbo].[up_select_review_event_s6]
	@company_seq		INT,
	@page				INT=1,
	@pagesize			INT=15,
	@ER_Type			INT=0,
...
*/
			...
			ELSE --더카드
				BEGIN
					SELECT count(ER_Idx) FROM S4_Event_Review WITH(NOLOCK) WHERE ER_Type=@ER_Type AND ER_Company_Seq=5007 AND ER_View=0 
...
*/
					...
					WHERE 
						...
						(
							...
							WHERE AA.ER_Company_Seq =5007 AND AA.ER_View=0 AND AA.ER_Type=@ER_Type 
