IF OBJECT_ID (N'dbo.SP_PP_MAIN_RANKING_LIST_SUPERSALE', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_PP_MAIN_RANKING_LIST_SUPERSALE
GO
...
-- =======================================================================================
CREATE PROCEDURE [dbo].[SP_PP_MAIN_RANKING_LIST_SUPERSALE] 
...
BEGIN
	...
	IF @brand = 'I' OR @brand = 'N' OR @brand = 'H' OR @brand = 'L' --I : 인기상품 , N : 신상품
		...
		IF @company_seq = 5003
		BEGIN
		SET @strQuery = @strQuery + '						and K.CardKind_Seq = 1													     '+char(13) + char(10)
		END 
