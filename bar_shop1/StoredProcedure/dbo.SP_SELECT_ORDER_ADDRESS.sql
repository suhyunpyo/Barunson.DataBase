IF OBJECT_ID (N'dbo.SP_SELECT_ORDER_ADDRESS', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_ORDER_ADDRESS
GO
...
GO
CREATE PROCEDURE [dbo].[SP_SELECT_ORDER_ADDRESS]
/***************************************************************
작성자	:	표수현
작성일	:	2022-03-10
...
AS
	...
	IF @GUBUN =  1 BEGIN 
			...
			SELECT	
					...
					[ADDRESS] =  REPLACE(REPLACE(B.ADDR ,CHAR(13),''),CHAR(10),'')  + ' ' +  REPLACE(REPLACE(dbo.UF_CHARDEL(B.ADDR_DETAIL) ,CHAR(13),''),CHAR(10),''), -- 수하인주소 (기본주소 + 상세주소),
					--[ADDRESS] =  REPLACE(REPLACE(B.ADDR ,CHAR(13),''),CHAR(10),'')  + ' ' +  REPLACE(REPLACE(B.ADDR_DETAIL ,CHAR(13),''),CHAR(10),''), -- 수하인주소 (기본주소 + 상세주소),
