IF OBJECT_ID (N'dbo.UP_INSERT_REVIEW3_NEW_PC_20220826', N'P') IS NOT NULL DROP PROCEDURE dbo.UP_INSERT_REVIEW3_NEW_PC_20220826
GO
...
수정일   작업자  DESCRIPTION      
********************************************************************/ 
CREATE PROCEDURE [dbo].[UP_INSERT_REVIEW3_NEW_PC_20220826]
	@COMPANY_SEQ	INT,
	@ORDER_SEQ		INT,
	@CARD_SEQ		INT,
...
AS
 ...
 --BEGIN TRAN
			...
			IF @EXIST_CNT = 0 BEGIN
    				...
    				VALUES 
    				(@COMPANY_SEQ, @ORDER_SEQ, @ER_TYPE, @CARD_SEQ, @CARD_CODE, @USERID, @사진첨부여부 , @REVIEWS_TITLE, @REVIEWS_URL, @REVIEWS_URL2, @REVIEWS_URL3, @CONTENT, 'sample', @SCORE, @USER_NAME, @REVIEWS_URL_A, @REVIEWS_URL_B, 'PC')
