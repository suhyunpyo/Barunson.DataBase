IF OBJECT_ID (N'dbo.SP_EVENT_MARKETING_AGREEMENT_V2', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EVENT_MARKETING_AGREEMENT_V2
GO
...
CREATE PROCEDURE [dbo].[SP_EVENT_MARKETING_AGREEMENT_V2]
