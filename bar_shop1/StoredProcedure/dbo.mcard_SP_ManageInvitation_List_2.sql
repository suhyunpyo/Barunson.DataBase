IF OBJECT_ID (N'dbo.mcard_SP_ManageInvitation_List_2', N'P') IS NOT NULL DROP PROCEDURE dbo.mcard_SP_ManageInvitation_List_2
GO
...
GO
CREATE PROCEDURE [dbo].[mcard_SP_ManageInvitation_List_2]
	@pageNo	INT
	, @pageSize	INT
...
BEGIN
	...
	IF @searchType = 'SITE' AND @searchText = 'B'
		BEGIN
			SET @siteSql = 'AND SiteCode in (''B'' , ''C'')'
		END
	ELSE
		BEGIN
