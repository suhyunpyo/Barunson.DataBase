IF OBJECT_ID (N'dbo.SP_INSERT_THK_MOVIE_EVENT_JEHU', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_INSERT_THK_MOVIE_EVENT_JEHU
GO
...
-- Description:	제휴 감사영상쿠폰발급

-- EXEC 쿠폰타입, 회원아이디, 사이트코드
-- EXEC dbo.SP_INSERT_MOVIE_EVENT '114013', 's5guest', 5001
-- =============================================

CREATE PROCEDURE [dbo].[SP_INSERT_THK_MOVIE_EVENT_JEHU]
	@UID							AS VARCHAR(50)
AS
BEGIN
	...
	SET @COUPON_TYPE_CODE = '114013'; -- 쿠폰타입코드
