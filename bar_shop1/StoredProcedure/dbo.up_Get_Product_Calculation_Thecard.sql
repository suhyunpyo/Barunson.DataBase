IF OBJECT_ID (N'dbo.up_Get_Product_Calculation_Thecard', N'P') IS NOT NULL DROP PROCEDURE dbo.up_Get_Product_Calculation_Thecard
GO
...
-- =============================================  
CREATE PROCEDURE [dbo].[up_Get_Product_Calculation_Thecard]    
