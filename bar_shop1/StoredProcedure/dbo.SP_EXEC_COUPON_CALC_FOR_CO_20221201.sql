IF OBJECT_ID (N'dbo.SP_EXEC_COUPON_CALC_FOR_CO_20221201', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_COUPON_CALC_FOR_CO_20221201
GO
...
*/
CREATE PROCEDURE [dbo].[SP_EXEC_COUPON_CALC_FOR_CO_20221201]
...
BEGIN
	...
	select @FIRST_COUPON_ORDER_PRICE pp
	--AND		(
