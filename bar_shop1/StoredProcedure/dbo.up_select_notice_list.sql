IF OBJECT_ID (N'dbo.up_select_notice_list', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_notice_list
GO
...
*/
-- =============================================
CREATE Procedure [dbo].[up_select_notice_list]
...
BEGIN
	...
	-- total count
			...
			select COUNT(seq) AS TOT from S2_Notice AS A with(nolock) 
				...
				and reg_date >= '2021-01-01' -- 2021-05-24 지민님 요청 : 2021년 이후 공지사항만 노출 되도록
