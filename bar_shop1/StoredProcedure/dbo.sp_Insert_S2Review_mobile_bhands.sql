IF OBJECT_ID (N'dbo.sp_Insert_S2Review_mobile_bhands', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_Insert_S2Review_mobile_bhands
GO
...
-- 2018.09.01 비핸즈 이용후기 rprice 추가
-- =============================================

CREATE PROCEDURE [dbo].[sp_Insert_S2Review_mobile_bhands]
	@sgubun varchar(2),
	@com_seq integer,
	@card_seq integer,
	...
	@rprice tinyint,
	@b_url varchar(2000),
	@img_name1 varchar(30),
	@upimg_name1 varchar(30),
	@img_name2 varchar(30),
	@upimg_name2 varchar(30),
	@img_name3 varchar(30),
	@upimg_name3 varchar(30),
	@img_name4 varchar(30),
	@upimg_name4 varchar(30),
	@img_name5 varchar(30),
	@upimg_name5 varchar(30)
AS
BEGIN
	...
	,@uname,@title,@comment,@score,@upfile,@comm_div,@rcolor,@rbright,@rprice, @b_url,'mobile'
			)
