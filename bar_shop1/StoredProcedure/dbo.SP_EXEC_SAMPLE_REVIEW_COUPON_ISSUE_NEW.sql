IF OBJECT_ID (N'dbo.SP_EXEC_SAMPLE_REVIEW_COUPON_ISSUE_NEW', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_SAMPLE_REVIEW_COUPON_ISSUE_NEW
GO
...
*********************************************************************************************************************/ 
CREATE PROCEDURE [dbo].[SP_EXEC_SAMPLE_REVIEW_COUPON_ISSUE_NEW]  
 @P_IDX INT,   
 @P_VIEW INT,
 @P_STATUS INT,   
