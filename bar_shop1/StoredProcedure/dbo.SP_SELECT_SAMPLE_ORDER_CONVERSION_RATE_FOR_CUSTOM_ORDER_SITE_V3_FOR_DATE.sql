IF OBJECT_ID (N'dbo.SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_CUSTOM_ORDER_SITE_V3_FOR_DATE', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_CUSTOM_ORDER_SITE_V3_FOR_DATE
GO
...
-- EXEC SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_CUSTOM_ORDER_SITE_V3_FOR_DATE  '2022-01-01', '2022-01-31', 'SB|SA|ST|SS|B|C|H'
-- EXEC SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_CUSTOM_ORDER_SITE_V3_FOR_DATE  '2022-05-01', '2022-05-31', 'SS'

-- Update date: 2022.05.27, 김광호
-- Description: 사이트 일치 조건, 추가주문 집계 제거
-- =============================================

CREATE PROCEDURE [dbo].[SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_CUSTOM_ORDER_SITE_V3_FOR_DATE]
...
BEGIN
	...
	DECLARE @T_SALES_GUBUN TABLE
    (
		[sSale] VARCHAR(2),
		[oSale] VARCHAR(2)
	)	
	INSERT @T_SALES_GUBUN ([sSale],[oSale])
	VALUES ('SB','SB'), ('SA','SA'), ('ST','ST'), ('SS','SS'), ('SD','SD'), ('B','B'), ('B','H'), ('C','C'), ('H','H')
			...
			From (
				...
				From CUSTOM_SAMPLE_ORDER as s
					Inner Join CUSTOM_ORDER o 
						...
						AND  o.SALES_GUBUN in (Select oSale From @T_SALES_GUBUN Where sSale = s.SALES_GUBUN)
