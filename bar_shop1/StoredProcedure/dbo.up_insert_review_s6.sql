IF OBJECT_ID (N'dbo.up_insert_review_s6', N'P') IS NOT NULL DROP PROCEDURE dbo.up_insert_review_s6
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[up_insert_review_s6]
...
BEGIN
	...
	BEGIN TRAN
		   ...
		   ,ER_Review_Url_b 
    		...
    		values 
    		(@company_seq, @order_seq, @ER_Type, @card_seq, @card_code, @userid, @reviews_title, @reviews_URL, @content, @score, @user_name,@star_rating1,@star_rating2,@star_rating3,@star_rating4, @reviews_URL_a, @reviews_URL_b)
