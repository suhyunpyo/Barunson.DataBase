IF OBJECT_ID (N'dbo.SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER_NEW', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER_NEW
GO
...
GO
CREATE PROC [dbo].[SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER_NEW]  
...
--	SET @MKT_CHK_FLAG = 'N'
 -- END 
    EXEC SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_NEW   @P_AUTHCODE, @CONNINFO, @AUTHTYPE, @UID, @PWD, @UNAME, @EMAIL, @BIRTH, @BIRTH_DIV, 
