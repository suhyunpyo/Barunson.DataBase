IF OBJECT_ID (N'dbo.SP_SELECT_MD_ITEM_LIST_HG', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_MD_ITEM_LIST_HG
GO
...
CREATE PROCEDURE [dbo].[SP_SELECT_MD_ITEM_LIST_HG]
		@P_MD_SEQ			AS INT
...
BEGIN
	...
	SELECT  SMC.MD_SEQ													AS MdSeq
		...
		,	MAX(SCD.DISCOUNT_RATE)										AS DiscountRate
