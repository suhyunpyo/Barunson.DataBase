IF OBJECT_ID (N'dbo.up_insert_event_comment_N', N'P') IS NOT NULL DROP PROCEDURE dbo.up_insert_event_comment_N
GO
...
-- Description:	이벤트 페이지 덧글 등록
-- =============================================
CREATE PROCEDURE [dbo].[up_insert_event_comment_N]
