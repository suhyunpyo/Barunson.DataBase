IF OBJECT_ID (N'dbo.up_Insert_S4_EventMusic_Reply', N'P') IS NOT NULL DROP PROCEDURE dbo.up_Insert_S4_EventMusic_Reply
GO
...
EXEC up_Insert_S4_EventMusic_Reply_test 219, 's4guest', 5001, 'asdasldkfalskdfaslkdf(✌’ω’)✌'

*/
CREATE proc [dbo].[up_Insert_S4_EventMusic_Reply]
