IF OBJECT_ID (N'dbo.up_select_ranking_all_product_list_SR_NSM', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_ranking_all_product_list_SR_NSM
GO
...
-- =============================================        
create PROCEDURE [dbo].[up_select_ranking_all_product_list_SR_NSM]        
