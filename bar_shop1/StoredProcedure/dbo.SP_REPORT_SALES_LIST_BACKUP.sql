IF OBJECT_ID (N'dbo.SP_REPORT_SALES_LIST_BACKUP', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_SALES_LIST_BACKUP
GO
...
CREATE PROCEDURE [dbo].[SP_REPORT_SALES_LIST_BACKUP]
