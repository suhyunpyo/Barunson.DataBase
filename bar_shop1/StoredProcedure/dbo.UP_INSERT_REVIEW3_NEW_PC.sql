IF OBJECT_ID (N'dbo.UP_INSERT_REVIEW3_NEW_PC', N'P') IS NOT NULL DROP PROCEDURE dbo.UP_INSERT_REVIEW3_NEW_PC
GO
...
수정일   작업자  DESCRIPTION      
********************************************************************/ 
CREATE PROCEDURE [dbo].[UP_INSERT_REVIEW3_NEW_PC]
	@COMPANY_SEQ	INT,
	@ORDER_SEQ		INT,
	@CARD_SEQ		INT,
