IF OBJECT_ID (N'dbo.SP_UPDATE_USER_INFO_V2', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_UPDATE_USER_INFO_V2
GO
...
CREATE PROC [dbo].[SP_UPDATE_USER_INFO_V2]
...
BEGIN
	...
	BEGIN TRY
		BEGIN TRAN TR_UPDATE
			...
			DECLARE @INTERGRATION_MEMBER_YORN AS VARCHAR(1) = 'Y'
