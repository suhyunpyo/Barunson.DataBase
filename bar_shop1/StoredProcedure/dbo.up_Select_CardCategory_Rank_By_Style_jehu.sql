IF OBJECT_ID (N'dbo.up_Select_CardCategory_Rank_By_Style_jehu', N'P') IS NOT NULL DROP PROCEDURE dbo.up_Select_CardCategory_Rank_By_Style_jehu
GO
...
*/
-- =============================================
CREATE PROCEDURE [dbo].[up_Select_CardCategory_Rank_By_Style_jehu]
(  
	  @Company_Seq		INT
	, @Order_Num		INT
	, @CardStyle_Num	INT
	...
	(
		...
		(
			...
			WHERE 1 = 1
				...
				AND G.CardImage_WSize = '210' 
				AND G.CardImage_HSize = '210' 
