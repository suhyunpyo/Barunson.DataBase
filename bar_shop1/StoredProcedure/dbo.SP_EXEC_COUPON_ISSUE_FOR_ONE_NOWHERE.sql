IF OBJECT_ID (N'dbo.SP_EXEC_COUPON_ISSUE_FOR_ONE_NOWHERE', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_COUPON_ISSUE_FOR_ONE_NOWHERE
GO
...
*/
CREATE PROCEDURE [dbo].[SP_EXEC_COUPON_ISSUE_FOR_ONE_NOWHERE]
		@COMPANY_SEQ			AS INT
