IF OBJECT_ID (N'dbo.PROC_SMS_MMS_SEND', N'P') IS NOT NULL DROP PROCEDURE dbo.PROC_SMS_MMS_SEND
GO
...
GO
/****************************************************************************************************************
-- SP Name       : PROC_SMS_MMS_SEND
-- Author        : 박혜림
-- Create date   : 2020-11-16
-- Description   : SMS & MMS 발송
-- Update History:
-- Comment       :
-- EXEC bar_shop1.dbo.PROC_SMS_MMS_SEND '', 0, '', '[디얼디어] 초안등록 완료 되었습니다. 오타, 교통편, 지명 등 다시 한번 확인 부탁드립니다.', '', '1661-2646', 1, 'AA^01067640922', 0, '', 0, 'SD', '단계별 DM', '초대장초안 - SP_MAILSEND_CHOAN', '', '', '', '', '', '', '', ''
****************************************************************************************************************/
CREATE PROCEDURE [dbo].[PROC_SMS_MMS_SEND]
...
-- MMS
--EXEC bar_shop1.dbo.PROC_SMS_MMS_SEND 's4guest', 0, '제목선택', 'MMS 발송 테스트', '', '1644-0708', 1, 'AA^010-8973-8286', 1, 'http://mcard.barunnfamily.com/Photos/202010/ST3021030/mmscard.jpg^1^0', 0, 'SS', '', '', '', '', @ErrNum OUTPUT, @ErrSev OUTPUT, @ErrState OUTPUT, @ErrProc OUTPUT, @ErrLine OUTPUT, @ErrMsg OUTPUT
