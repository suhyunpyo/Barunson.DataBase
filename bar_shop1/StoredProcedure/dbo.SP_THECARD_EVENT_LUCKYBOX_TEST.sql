IF OBJECT_ID (N'dbo.SP_THECARD_EVENT_LUCKYBOX_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_THECARD_EVENT_LUCKYBOX_TEST
GO
...
CREATE PROCEDURE [dbo].[SP_THECARD_EVENT_LUCKYBOX_TEST]
	@UID								AS VARCHAR(50)
AS
BEGIN
