IF OBJECT_ID (N'dbo.up_select_mypage_sample_list', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_mypage_sample_list
GO
...
-- =============================================    
CREATE PROCEDURE [dbo].[up_select_mypage_sample_list]    
