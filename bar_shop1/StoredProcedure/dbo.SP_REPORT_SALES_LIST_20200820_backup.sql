IF OBJECT_ID (N'dbo.SP_REPORT_SALES_LIST_20200820_backup', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_SALES_LIST_20200820_backup
GO
...
*/
CREATE PROCEDURE [dbo].[SP_REPORT_SALES_LIST_20200820_backup]
...
INNER JOIN    Coupon_MST AS CM ON CD.Coupon_MST_Seq = CM.Coupon_MST_Seq
	...
	SELECT	
		...
		,	CASE WHEN dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131001') IS NOT NULL AND dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131001') <> '' THEN dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131001')
			ELSE
		...
		,   CASE WHEN dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131002') IS NOT NULL AND dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131002') <> '' THEN dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131002')
			ELSE
		...
		,   CASE WHEN dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131003') IS NOT NULL AND dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131003') <> '' THEN dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131003')
			ELSE
		...
		,   CASE WHEN dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131004') IS NOT NULL AND dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131004') <> '' THEN dbo.FN_ORDER_COUPON_LIST(CO.ORDER_SEQ,'131004')
			ELSE
