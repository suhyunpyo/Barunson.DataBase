IF OBJECT_ID (N'dbo.SP_frmCorelPhoto2_LISTVIEW_', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_frmCorelPhoto2_LISTVIEW_
GO
...
EXEC SP_frmCorelPhoto2_LISTVIEW_ '3143978', '', '0', '0', '0', '2021-03-30', '2021-04-30', 0, 0, '3', '20210430', '20210430', '0', '', 10000
*/
CREATE PROCEDURE [dbo].[SP_frmCorelPhoto2_LISTVIEW_]
...
WHERE @ORDER_TYPE IN ('0', '12' ) AND CC.HardID = 'DigitalCardCode' AND CC.HardUse = 'Y'
	...
	WHERE 1 = 1 
		...
		AND ( 
			...
			OR	( @ORDER_TYPE = '12' AND (C.isMasterDigital = '1' OR A.ORDER_SEQ in (SELECT ORDER_SEQ FROM #POCKET_SUB_CARD)) )
		)
