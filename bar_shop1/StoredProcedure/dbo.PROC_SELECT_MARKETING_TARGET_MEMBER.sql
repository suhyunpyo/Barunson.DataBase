IF OBJECT_ID (N'dbo.PROC_SELECT_MARKETING_TARGET_MEMBER', N'P') IS NOT NULL DROP PROCEDURE dbo.PROC_SELECT_MARKETING_TARGET_MEMBER
GO
...
--EXEC PROC_SELECT_MARKETING_TARGET_MEMBER 'SB|ST|SS|B', 'Y', 'N', NULL, 'Y', 'Y', '서울|경기|인천|대전|대구|세종|제주|광주|부산|울산|경남|경북|전남|전북|충남|충북|강원', NULL, NULL, NULL, '2023-03-01', '2023-05-31', '1990', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 50, 2, 'P'

CREATE PROCEDURE [dbo].[PROC_SELECT_MARKETING_TARGET_MEMBER]
