IF OBJECT_ID (N'dbo.SP_EXEC_MMS_SEND_FOR_FINDPROPERTY_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_MMS_SEND_FOR_FINDPROPERTY_TEST
GO
...
GO
CREATE PROCEDURE [dbo].[SP_EXEC_MMS_SEND_FOR_FINDPROPERTY_TEST]  
/***************************************************************
작성자	:	표수현
작성일	:	2022-05-17
DESCRIPTION	:	
...
SET @MMS_MSG = '(광고) 온라인부동산#찾아줘부동산 에서 나만의신혼집도 찾으시고

비스포크 냉장고를 무료로 받아가세요.
자세한 내용은 하단의 링크 에서 확인하세요.

https://bit.ly/39wgVrp

#' + @NO_REC_BRAND + ' 고객특전#브이패스50%할인

※ 본 문자는 ' + CONVERT(VARCHAR(10), DATEADD(DAY, -1, GETDATE()), 120) + ' 기준,
SMS 수신동의한 고객님께
발송되었습니다.
