IF OBJECT_ID (N'dbo.SP_SELECT_CHOAN_JOB_COUNT_LIST_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_CHOAN_JOB_COUNT_LIST_TEST
GO
...
-- EXEC [SP_SELECT_CHOAN_JOB_COUNT_LIST_TEST] '2022-02-01', '2022-02-28', 'Y'

CREATE PROCEDURE [dbo].[SP_SELECT_CHOAN_JOB_COUNT_LIST_TEST]
