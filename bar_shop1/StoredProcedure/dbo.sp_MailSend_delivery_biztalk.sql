IF OBJECT_ID (N'dbo.sp_MailSend_delivery_biztalk', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_MailSend_delivery_biztalk
GO
...
exec sp_MailSend_delivery_biztalk  4136435,'010-8996-1225','SB','초대장배송'
exec sp_MailSend_delivery_biztalk  4140183,'010-8996-1225','B','초대장배송'
exec sp_MailSend_delivery_biztalk  4136549,'010-8996-1225','SS','초대장배송'
exec sp_MailSend_delivery_biztalk  4138059,'010-8996-1225','ST','초대장배송'
...
CREATE procedure [dbo].[sp_MailSend_delivery_biztalk]
	@order_seq integer
...
BEGIN
	...
	DECLARE @deliveryname as varchar(50)
	 ...
	 --set @nowdate = getdate()
	 --if @nowdate > '2022-09-05' and @nowdate < '2022-09-08'
	 -- return
