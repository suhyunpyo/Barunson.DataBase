IF OBJECT_ID (N'dbo.sp_MailSend_delivery_confirm_event', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_MailSend_delivery_confirm_event
GO
...
CREATE procedure [dbo].[sp_MailSend_delivery_confirm_event]
	@day_num		INT
as
...
where  a.card_seq = c.card_seq and b.settle_type='0' and datediff(day,src_send_date,getdate()) =@day_num
OPEN tbl_cursor
