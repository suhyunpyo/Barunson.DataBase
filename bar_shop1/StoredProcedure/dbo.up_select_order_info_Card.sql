IF OBJECT_ID (N'dbo.up_select_order_info_Card', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_order_info_Card
GO
...
CREATE PROCEDURE [dbo].[up_select_order_info_Card]        
 ...
 */        
 ...
 SELECT   A.order_seq   --0        
   ...
   , isnull((select top 1 'Y' from except_choan_view_list where order_Seq = a.order_seq),'N') choanView
   , isSpecial
 FROM Custom_Order A         
