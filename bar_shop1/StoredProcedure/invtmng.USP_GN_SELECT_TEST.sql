IF OBJECT_ID (N'invtmng.USP_GN_SELECT_TEST', N'P') IS NOT NULL DROP PROCEDURE invtmng.USP_GN_SELECT_TEST
GO
...
CREATE PROC [invtmng].[USP_GN_SELECT_TEST] (   
...
set @strQuery = 'select ' + @strFields + ' from ' + @strTables + @strFilterCriteria + ' AND member_id=' + 's4guest' + @strGroupCriteria + @strSortCriteria   
