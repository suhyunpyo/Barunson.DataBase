IF OBJECT_ID (N'dbo.SP_SELECT_VW_USER_INFO_FOR_AGE_AND_SEX', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_VW_USER_INFO_FOR_AGE_AND_SEX
GO
...
*/
CREATE PROCEDURE [dbo].[SP_SELECT_VW_USER_INFO_FOR_AGE_AND_SEX]
...
FROM    (
            SELECT  CAST(BIRTHDATE AS DATETIME) AS BIRTHDATE, GENDER
            FROM    S2_USERINFO
            WHERE   UID = @UID
