IF OBJECT_ID (N'dbo.up_select_ranking_all_product_list_SR', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_ranking_all_product_list_SR
GO
...
-- =============================================        
CREATE PROCEDURE [dbo].[up_select_ranking_all_product_list_SR]        
