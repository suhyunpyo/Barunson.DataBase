IF OBJECT_ID (N'dbo.SP_EXEC_COUPON_ISSUE_FOR_ONE_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_COUPON_ISSUE_FOR_ONE_TEST
GO
...
EXEC [SP_EXEC_COUPON_ISSUE_FOR_ONE_TEST] 5003, 'SS', 's4guest', '2D28-9C87-49B9-A2BF'
...
*/
CREATE PROCEDURE [dbo].[SP_EXEC_COUPON_ISSUE_FOR_ONE_TEST]
		@COMPANY_SEQ			AS INT
