IF OBJECT_ID (N'dbo.SP_REPORT_SIGN_UP_AND_SIGN_IN', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_SIGN_UP_AND_SIGN_IN
GO
...
CREATE PROCEDURE [dbo].[SP_REPORT_SIGN_UP_AND_SIGN_IN]  
