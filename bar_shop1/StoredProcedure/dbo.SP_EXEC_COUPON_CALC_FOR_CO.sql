...
SELECT TOP 100 * FROM VW_COUPON_CALC_FOR_CO

*/
ALTER PROCEDURE [dbo].[SP_EXEC_COUPON_CALC_FOR_CO]
...
BEGIN
	...
	SELECT	@SECOND_COUPON_ORDER_PRICE = 
			CASE 
					...
					ELSE	
							CASE 
									WHEN	FLOOR((DISCOUNT_TARGET_ORDER_PRICE - @FIRST_COUPON_ORDER_PRICE) * (1.0 * DISCOUNT_VALUE / 100)) > DISCOUNT_MAX_AMT
									THEN	DISCOUNT_MAX_AMT
									ELSE	FLOOR((DISCOUNT_TARGET_ORDER_PRICE - @FIRST_COUPON_ORDER_PRICE) * (1.0 * DISCOUNT_VALUE / 100))
							END
			END
	...
	FROM	(
				...
				SELECT	ORDER_SEQ
					...
					,	DISCOUNT_TARGET_LININGJAEBON_PRICE
					...
					,	CASE 
								...
								THEN
										CASE 
												...
												ELSE	
														CASE 
																WHEN	FLOOR(DISCOUNT_TARGET_ORDER_PRICE_TEMP * (1.0 * DISCOUNT_VALUE / 100)) > DISCOUNT_MAX_AMT AND DISCOUNT_MAX_AMT > 0
																THEN	DISCOUNT_MAX_AMT
																ELSE	FLOOR(DISCOUNT_TARGET_ORDER_PRICE_TEMP * (1.0 * DISCOUNT_VALUE / 100))
														END
										END
								ELSE 0
