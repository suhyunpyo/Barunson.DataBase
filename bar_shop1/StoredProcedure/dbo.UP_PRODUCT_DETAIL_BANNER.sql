IF OBJECT_ID (N'dbo.UP_PRODUCT_DETAIL_BANNER', N'P') IS NOT NULL DROP PROCEDURE dbo.UP_PRODUCT_DETAIL_BANNER
GO
...
-- =============================================        
	...
	CREATE PROCEDURE [dbo].[UP_PRODUCT_DETAIL_BANNER]    
 ...
 BEGIN    
  SELECT SEQ    
   ...
   WHERE USE_YORN  = 'Y'    
     ...
     AND (    
    (TARGET_TYPE = 'C' AND (ITEM_TYPE1_YORN = @ITEM_TYPE1_YORN OR ITEM_TYPE2_YORN = @ITEM_TYPE2_YORN))    
    OR     
    (TARGET_TYPE = 'P' AND CARD_CODE LIKE '%' + @CARD_CODE + '%')    
    )    
