IF OBJECT_ID (N'dbo.SP_EXEC_COUPON_CALC_FOR_CO_1107', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_COUPON_CALC_FOR_CO_1107
GO
...
EXEC [SP_EXEC_COUPON_CALC_FOR_CO_1107] 's4guest', 2893801, '', ''
...
*/
CREATE PROCEDURE [dbo].[SP_EXEC_COUPON_CALC_FOR_CO_1107]
...
BEGIN
	...
	WHERE	1 = 1
	AND		A.DISCOUNT_TOTAL_PRICE > 0 -- 할인금액이 0보다 큰 쿠폰만 가져온다
