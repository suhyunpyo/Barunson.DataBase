IF OBJECT_ID (N'dbo.SP_INSERT_THK_MOVIE_EVENT_SA', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_INSERT_THK_MOVIE_EVENT_SA
GO
...
-- 원주문/청첩장구매시 발급
-- EXEC dbo.[SP_INSERT_THK_MOVIE_EVENT_SA] 주문번호, 's5guest'
-- =============================================

CREATE PROCEDURE [dbo].[SP_INSERT_THK_MOVIE_EVENT_SA]
	@ORDER_SEQ       					AS INT,
	@UID								AS VARCHAR(50)
AS
BEGIN
