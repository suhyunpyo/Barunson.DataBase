IF OBJECT_ID (N'dbo.SP_REPORT_MARKETING_AGREE_BY_ORDER_SAMPLE_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_MARKETING_AGREE_BY_ORDER_SAMPLE_TEST
GO
...
-- =============================================  
CREATE PROCEDURE [dbo].[SP_REPORT_MARKETING_AGREE_BY_ORDER_SAMPLE_TEST]  
