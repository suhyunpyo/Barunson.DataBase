IF OBJECT_ID (N'dbo.SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_WEDDING', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_WEDDING
GO
...
EXEC SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_WEDDING '2017-07', '2017-07', 'SB|SA|ST|SS'

*/
CREATE PROCEDURE [dbo].[SP_SELECT_SAMPLE_ORDER_CONVERSION_RATE_FOR_WEDDING]
