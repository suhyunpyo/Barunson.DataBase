IF OBJECT_ID (N'dbo.SP_REPORT_SALES_LIST_ORIGINAL_DO_NOT_REMOVE', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_SALES_LIST_ORIGINAL_DO_NOT_REMOVE
GO
...
*/  
CREATE PROCEDURE [dbo].[SP_REPORT_SALES_LIST_ORIGINAL_DO_NOT_REMOVE]  
...
*/
 ...
 INTO #T  
 FROM    Custom_Order AS CO   WITH(NOLOCK)
 ...
 ELSE IF @P_List_Type = 'List_Excel'  
  BEGIN  
   ...
   WHERE ISNULL(A.card_price, 0) = 0 AND A.sales_Gubun = 'SD'  
	...
	INTO #Custom_WOrder  	 
    FROM Custom_Order AS CWO   WITH(NOLOCK)
