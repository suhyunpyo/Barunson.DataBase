IF OBJECT_ID (N'dbo.up_select_md_product_list_search', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_md_product_list_search
GO
...
-- 변경 : [up_select_md_product_list_search] 729, 5007, 100  
-- =============================================          
CREATE PROCEDURE [dbo].[up_select_md_product_list_search]        
 @MD_SEQ int,    -- 회사고유코드          
