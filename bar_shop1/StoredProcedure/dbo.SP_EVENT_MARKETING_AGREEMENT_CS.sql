IF OBJECT_ID (N'dbo.SP_EVENT_MARKETING_AGREEMENT_CS', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EVENT_MARKETING_AGREEMENT_CS
GO
...
EXEC SP_EVENT_MARKETING_AGREEMENT_V2 'sharniel1','B'
...
CREATE PROCEDURE [dbo].[SP_EVENT_MARKETING_AGREEMENT_CS]
...
BEGIN
	...
	-- 보험(교보)
	--select @cnt2 = count(*) from S2_USERINFO_THIRD_PARTY_MARKETING_AGREEMENT where uid = @USER_ID and MARKETING_TYPE_CODE = '119005'
	...
	select @cnt5 = count(*) from S2_USERINFO_THIRD_PARTY_MARKETING_AGREEMENT where uid = @USER_ID and MARKETING_TYPE_CODE = '119006'
