IF OBJECT_ID (N'dbo.SP_SELECT_BENEFIT_BANNER_V2_LIST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_BENEFIT_BANNER_V2_LIST
GO
...
EXEC SP_SELECT_BENEFIT_BANNER_V2_LIST 5006
*/

CREATE PROCEDURE [dbo].[SP_SELECT_BENEFIT_BANNER_V2_LIST]
...
BEGIN
	...
	FROM	(
				SELECT	VALUE AS B_TYPE
					,	1 AS B_TYPE_NO	
				FROM	DBO.FN_SPLIT('A1|A2|A3|I1|I2|I3|C1|C2|C3', '|') MST
				UNION ALL
				SELECT	VALUE AS B_TYPE
					,	2 AS B_TYPE_NO	
				FROM	DBO.FN_SPLIT('A1|A2|A3|I1|I2|I3|C1|C2|C3', '|') MST
	...
	ORDER BY	CASE 
					...
					WHEN MST.B_TYPE = 'I1' THEN 4
					WHEN MST.B_TYPE = 'I2' THEN 5
					WHEN MST.B_TYPE = 'I3' THEN 6
					WHEN MST.B_TYPE = 'C1' THEN 7
					WHEN MST.B_TYPE = 'C2' THEN 8
					WHEN MST.B_TYPE = 'C3' THEN 9
				END ASC
			,	MST.B_TYPE_NO ASC
