IF OBJECT_ID (N'dbo.SP_SELECT_USER_FOR_ORDER_INFO_HG', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_USER_FOR_ORDER_INFO_HG
GO
...
EXEC SP_SELECT_USER_FOR_ORDER_INFO_HG  '2018-01-23', '2018-01-30', '', '', '', 'B'
SELECT  (DATEDIFF(DAY, '19800316',GETDATE())-DATEDIFF(YEAR,'19800316',GETDATE())/4)/365

***/
CREATE Procedure [dbo].[SP_SELECT_USER_FOR_ORDER_INFO_HG]  
...
BEGIN
    ...
    ,   MAX(UID)                                AS UID
    ,   MAX(UMAIL)                              AS UMAIL
    --,   LEFT(MAX(BIRTHDATE), 4)                 AS BIRTHDATE
