IF OBJECT_ID (N'dbo.SP_EXEC_DELIVERY_RECEIPT_FOR_CJ_NEW_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_DELIVERY_RECEIPT_FOR_CJ_NEW_TEST
GO
...
*/
CREATE PROCEDURE [dbo].[SP_EXEC_DELIVERY_RECEIPT_FOR_CJ_NEW_TEST]
