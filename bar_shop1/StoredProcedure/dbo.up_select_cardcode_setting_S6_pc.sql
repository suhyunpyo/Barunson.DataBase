IF OBJECT_ID (N'dbo.up_select_cardcode_setting_S6_pc', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_cardcode_setting_S6_pc
GO
...
GO
CREATE PROCEDURE [dbo].[up_select_cardcode_setting_S6_pc]
