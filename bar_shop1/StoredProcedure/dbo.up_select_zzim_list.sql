IF OBJECT_ID (N'dbo.up_select_zzim_list', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_zzim_list
GO
...
-- Description:	찜리스트 
-- =============================================
create PROCEDURE [dbo].[up_select_zzim_list]
...
BEGIN
	...
	SET NOCOUNT ON;
			...
			From S2_WishCard a 
			join s2_cardsalessite b on A.card_Seq = B.card_Seq and b.Company_Seq=@company_seq
