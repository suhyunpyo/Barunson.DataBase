IF OBJECT_ID (N'dbo.SP_PP_MAIN_RANKING_LIST_20230209', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_PP_MAIN_RANKING_LIST_20230209
GO
...
-- =======================================================================================
CREATE PROCEDURE [dbo].[SP_PP_MAIN_RANKING_LIST_20230209] 
...
BEGIN
	...
	IF @brand = 'I' OR @brand = 'N' --I : 인기상품 , N : 신상품
		BEGIN
			...
			--SET @strQuery = @strQuery + '					Wishcard, sampleCnt	     '+char(13) + char(10)
            ...
            SET @strQuery = @strQuery + '					ISNULL((SELECT top 1  ''Y'' FROM s2_samplebasket WHERE COMPANY_SEQ = 5003 AND CARD_SEQ = A.RK_Card_Code AND UID=@IN_uid and uid <> '''') , ''N'') sampleCnt'+char(13) + char(10)
