IF OBJECT_ID (N'dbo.up_insert_delete_sample_boton', N'P') IS NOT NULL DROP PROCEDURE dbo.up_insert_delete_sample_boton
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[up_insert_delete_sample_boton]
