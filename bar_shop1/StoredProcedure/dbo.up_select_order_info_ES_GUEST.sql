IF OBJECT_ID (N'dbo.up_select_order_info_ES_GUEST', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_order_info_ES_GUEST
GO
...
-- 비회원 샘플 주문 상세페이지
-- TEST : up_select_order_info_ES_guest 3148112, 'palaoh@naver.com', 5007, 'E'  
-- =============================================
CREATE PROCEDURE [dbo].[up_select_order_info_ES_GUEST]
