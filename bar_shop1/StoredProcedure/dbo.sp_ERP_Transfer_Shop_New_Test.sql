IF OBJECT_ID (N'dbo.sp_ERP_Transfer_Shop_New_Test', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_ERP_Transfer_Shop_New_Test
GO
...
--SP_LOCK
-- EXEC sp_ERP_Transfer_Shop_New '20150818','20150818'
-- select * from custom_etc_order where order_type = 'H' and status_seq = 12

CREATE PROCEDURE [dbo].[sp_ERP_Transfer_Shop_New_Test]
 @SDate as char(8)
 , @EDate as char(8)
...
WHERE A.status_Seq = 15  -- 배송완료  
 and A.src_send_date BETWEEN @SDate AND @EDate  
...
WHERE A.delivery_Date BETWEEN @SDate AND @EDate  
 AND A.STATUS_SEQ = 12  
