IF OBJECT_ID (N'dbo.SP_EXEC_SMS_OR_MMS_SEND', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_SMS_OR_MMS_SEND
GO
...
/*
EXEC SP_EXEC_SMS_OR_MMS_SEND '1644-0708', '010-8973-8286', '', 'SP 발송 테스트', 'SA', '웹발송', '', '2020-11-16 14:25:00', 0, ''
EXEC SP_EXEC_SMS_OR_MMS_SEND '1644-0708', '010-8973-8286', '이미지 전송', '이미지 전송 테스트', 'SA', '웹발송', '', '2020-11-16 14:25:00', 1, 'http://mcard.barunnfamily.com/Photos/202010/ST3021030/mmscard.jpg'
*/

CREATE PROCEDURE [dbo].[SP_EXEC_SMS_OR_MMS_SEND]
...
BEGIN
	...
	-- KT
	----------------------------------------------------------------------------------
	EXEC bar_shop1.dbo.PROC_SMS_MMS_SEND '', @SCHEDULE_TYPE, @P_SUBJECT, @P_MSG, @P_RESERVATION_DATE, @P_PHONE_SENDER, 1, @DEST_INFO, @P_FILE_CNT, @P_FILE_PATH, 0, @P_SALES_GUBUN, @P_SMS_TYPE, @P_REMARKS, '', '', '', '', '', '', '', ''
