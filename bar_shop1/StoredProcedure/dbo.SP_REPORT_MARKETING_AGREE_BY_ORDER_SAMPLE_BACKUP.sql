IF OBJECT_ID (N'dbo.SP_REPORT_MARKETING_AGREE_BY_ORDER_SAMPLE_BACKUP', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_MARKETING_AGREE_BY_ORDER_SAMPLE_BACKUP
GO
...
-- =============================================  
CREATE PROCEDURE [dbo].[SP_REPORT_MARKETING_AGREE_BY_ORDER_SAMPLE_BACKUP]  
