IF OBJECT_ID (N'dbo.SP_SELECT_S4_MD_CHOICE_LIST_INCLUDE_PAGING', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_S4_MD_CHOICE_LIST_INCLUDE_PAGING
GO
...
EXEC SP_SELECT_S4_MD_CHOICE_LIST_INCLUDE_PAGING 380, 'Y', 1, 5      
      
*/      
  
CREATE PROCEDURE [dbo].[SP_SELECT_S4_MD_CHOICE_LIST_INCLUDE_PAGING]      
    @MD_SEQ AS INT      
