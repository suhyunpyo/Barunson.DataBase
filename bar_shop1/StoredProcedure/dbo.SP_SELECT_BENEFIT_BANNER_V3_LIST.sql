IF OBJECT_ID (N'dbo.SP_SELECT_BENEFIT_BANNER_V3_LIST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_BENEFIT_BANNER_V3_LIST
GO
...
CREATE PROCEDURE [dbo].[SP_SELECT_BENEFIT_BANNER_V3_LIST]
...
BEGIN
	...
	FROM	(
				SELECT	VALUE AS B_TYPE
					,	3 AS B_TYPE_NO	
				FROM	DBO.FN_SPLIT('V1|V2|V3|V4|V5', '|') MST
				UNION ALL
				SELECT	VALUE AS B_TYPE
					,	4 AS B_TYPE_NO	
				FROM	DBO.FN_SPLIT('V1|V2|V3|V4|V5', '|') MST
	...
	ORDER BY	CASE 
					WHEN MST.B_TYPE = 'V1' THEN 1
					WHEN MST.B_TYPE = 'V2' THEN 2
					WHEN MST.B_TYPE = 'V3' THEN 3
					WHEN MST.B_TYPE = 'V4' THEN 4
					WHEN MST.B_TYPE = 'V5' THEN 5
				END ASC
			,	MST.B_TYPE_NO ASC
