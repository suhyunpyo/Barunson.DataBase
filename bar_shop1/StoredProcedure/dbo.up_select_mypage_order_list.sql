IF OBJECT_ID (N'dbo.up_select_mypage_order_list', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_mypage_order_list
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[up_select_mypage_order_list]
...
BEGIN
	...
	(
		...
		(			
			...
			INNER JOIN DELIVERY_INFO C ON A.order_seq = c.ORDER_SEQ
