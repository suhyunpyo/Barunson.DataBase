IF OBJECT_ID (N'dbo.SP_BEST_SAMPLE_WEEK_THECARD', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_BEST_SAMPLE_WEEK_THECARD
GO
...
CREATE PROCEDURE [dbo].[SP_BEST_SAMPLE_WEEK_THECARD]
	@ST_SEQ  		nvarchar(10),
	@UID			nvarchar(100)
AS
BEGIN
