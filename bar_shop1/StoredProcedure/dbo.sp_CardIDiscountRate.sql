IF OBJECT_ID (N'dbo.sp_CardIDiscountRate', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_CardIDiscountRate
GO
...
CREATE Procedure [dbo].[sp_CardIDiscountRate]
	@card_seq 	int,
	@order_count   int
as
begin
