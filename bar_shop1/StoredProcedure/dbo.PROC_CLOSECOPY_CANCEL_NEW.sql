IF OBJECT_ID (N'dbo.PROC_CLOSECOPY_CANCEL_NEW', N'P') IS NOT NULL DROP PROCEDURE dbo.PROC_CLOSECOPY_CANCEL_NEW
GO
...
GO
CREATE PROCEDURE [dbo].[PROC_CLOSECOPY_CANCEL_NEW]
	@ORDER_SEQ INT
--,@RSLT TINYINT OUTPUT
AS
BEGIN
