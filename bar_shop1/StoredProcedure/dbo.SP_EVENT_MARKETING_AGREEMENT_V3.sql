IF OBJECT_ID (N'dbo.SP_EVENT_MARKETING_AGREEMENT_V3', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EVENT_MARKETING_AGREEMENT_V3
GO
...
20220729 표수현 - 2022년 8월 1일부터 현대백화점 신촌점 제휴 종료로 인해 날짜로 예외처리 조건 추가(Line 196)
*/

CREATE PROCEDURE [dbo].[SP_EVENT_MARKETING_AGREEMENT_V3]
...
BEGIN
	...
	set   
	   mkt_chk_flag = 'Y'
	   --,chk_smembership = 'Y'  -- 2022년 7월 1일부터 삼성 제휴 종료로 인해 업데이트 대상 제외
