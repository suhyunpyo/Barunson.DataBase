IF OBJECT_ID (N'dbo.PROC_EVENT2_BIZTALK', N'P') IS NOT NULL DROP PROCEDURE dbo.PROC_EVENT2_BIZTALK
GO
...
GO
/****************************************************************************************************************
-- SP Name       : PROC_EVENT2_BIZTALK
-- Author        : 박혜림
-- Create date   : 2022-05-12
-- Description   : 이벤트 알림톡 발송
-- Update History: 2022-06-07 (박혜림) - +2일 이후 자동 발송으로 변경
-- Comment       : 샘플 발송일 기준, +2일 이후 자동 발송
****************************************************************************************************************/
CREATE PROCEDURE [dbo].[PROC_EVENT2_BIZTALK]
