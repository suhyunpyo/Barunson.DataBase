IF OBJECT_ID (N'dbo.SP_SELECT_S2_CARD_FOR_SAVE', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_S2_CARD_FOR_SAVE
GO
...
EXEC SP_SELECT_S2_CARD_FOR_SAVE '1|14|2|6|7|3|4|5|', 'C06|B02', '', '5001|5003|5006|5007|5000','1','1','1','1','1','1','1',20,1
EXEC SP_SELECT_S2_CARD_FOR_SAVE '3|4|5|16', '', '', '5001|5006|5000','1','','1','1','1','','1','N',9,20,1
EXEC SP_SELECT_S2_CARD_FOR_ALL '3|4|5|16', '', '', '5001|5006|5000','1','','1','1','1','','1',20,1
...
CREATE PROCEDURE [dbo].[SP_SELECT_S2_CARD_FOR_SAVE]
...
BEGIN
	...
	-- 
	--지선씨가 기존 DB 정보 남겨 둔 상태에서 추가가 되게끔 해달라고 요청 // 17.08.09
	-- 
	--DELETE FROM COUPON_APPLY_CARD WHERE COUPON_MST_SEQ = @P_COUPON_MST_SEQ;



	;
	WITH CTE_CARD_INFO AS
	(
	SELECT		DISTINCT
	...
	INSERT INTO COUPON_APPLY_CARD ( COUPON_MST_SEQ, CARD_SEQ, CARD_ALLOW_YN)
	SELECT 
			@P_COUPON_MST_SEQ
		,	CardSeq
		,	@P_CARD_ALLOW_YN
	...
	FROM	CTE_CARD_INFO
	WHERE	CardSeq NOT IN (SELECT CARD_SEQ FROM COUPON_APPLY_CARD WHERE COUPON_MST_SEQ = @P_COUPON_MST_SEQ) 
