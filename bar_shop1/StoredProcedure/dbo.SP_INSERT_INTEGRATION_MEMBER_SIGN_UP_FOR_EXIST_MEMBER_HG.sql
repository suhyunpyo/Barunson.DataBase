IF OBJECT_ID (N'dbo.SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER_HG', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER_HG
GO
...
, ''
, '' 
, ''
, ''

*/

CREATE PROC [dbo].[SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER_HG]
...
BEGIN
    ...
    IF @P_CONNINFO <> '' AND (@UID = '' OR @UID IS NULL)
    BEGIN
    ...
    EXEC SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_HG   @P_AUTHCODE
                                            ,   @CONNINFO
											,	@AUTHTYPE
                                            ,   @UID             
                                            ,   @PWD
