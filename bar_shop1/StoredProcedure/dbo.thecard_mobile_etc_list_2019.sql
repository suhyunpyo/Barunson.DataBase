IF OBJECT_ID (N'dbo.thecard_mobile_etc_list_2019', N'P') IS NOT NULL DROP PROCEDURE dbo.thecard_mobile_etc_list_2019
GO
...
-- 2019.11.29 HR  
-- EXEC thecard_mobile_etc_list_2019 5007, 'C18', 1, 20
-- 2020년 캘린더 추가를 위해 임시 작업 (D:\inetpub\TheCard_Mobile\mobile\card\addition_etc_list_proc.asp ) 
-- =============================================    
CREATE PROCEDURE [dbo].[thecard_mobile_etc_list_2019]  
...
BEGIN  
 ...
 IF (@card_div = 'C18') 
 BEGIN
	SET @card_div_list = @card_div_list + ',C13'
 END 
