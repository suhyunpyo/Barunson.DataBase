IF OBJECT_ID (N'dbo.SP_EXEC_COUPON_ISSUE_FOR_ONE', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_COUPON_ISSUE_FOR_ONE
GO
...
*/
CREATE PROCEDURE [dbo].[SP_EXEC_COUPON_ISSUE_FOR_ONE]
		@COMPANY_SEQ			AS INT
