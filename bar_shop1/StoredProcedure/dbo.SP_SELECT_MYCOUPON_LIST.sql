IF OBJECT_ID (N'dbo.SP_SELECT_MYCOUPON_LIST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_MYCOUPON_LIST
GO
...
CREATE PROCEDURE [dbo].[SP_SELECT_MYCOUPON_LIST]
...
--insert into SMARTAD_MYCOUPON (
--SMARTAD_COUPON_MST_SEQ
--,COUPON_CD
--,AD_SEQ
--,UID
--,USE_YORN
