IF OBJECT_ID (N'dbo.SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER
GO
...
CREATE PROC [dbo].[SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER]  
...
BEGIN  
 ...
 --EXEC SP_INSERT_BARUNN_INTEGRATE_USER_CHANGE_PROGRESS_LOG @P_AUTHCODE, @P_UID, 'SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_FOR_EXIST_MEMBER', @LOG_MSG  
    ...
    EXEC SP_INSERT_INTEGRATION_MEMBER_SIGN_UP   @P_AUTHCODE  
                                            ,   @CONNINFO  
											, @AUTHTYPE  
                                            ,   @UID               
                                            ,   @PWD  
