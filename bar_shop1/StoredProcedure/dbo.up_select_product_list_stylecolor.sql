IF OBJECT_ID (N'dbo.up_select_product_list_stylecolor', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_product_list_stylecolor
GO
...
*/
-- =============================================
CREATE Procedure [dbo].[up_select_product_list_stylecolor]
