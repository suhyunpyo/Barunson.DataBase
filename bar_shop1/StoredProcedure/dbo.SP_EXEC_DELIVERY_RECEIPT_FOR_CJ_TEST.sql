IF OBJECT_ID (N'dbo.SP_EXEC_DELIVERY_RECEIPT_FOR_CJ_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_DELIVERY_RECEIPT_FOR_CJ_TEST
GO
...
*/
CREATE PROCEDURE [dbo].[SP_EXEC_DELIVERY_RECEIPT_FOR_CJ_TEST]
...
BEGIN TRY
    ...
    DECLARE DELIVERY_CURSOR CURSOR LOCAL FOR
	 ...
	 SELECT ORDER_SEQ = A.ORDER_SEQ,
			...
			--RECV_ZIP = '99876', --isnull(A.RECV_ZIP, '123123'),
