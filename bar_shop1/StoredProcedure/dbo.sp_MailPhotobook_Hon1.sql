IF OBJECT_ID (N'dbo.sp_MailPhotobook_Hon1', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_MailPhotobook_Hon1
GO
...
CREATE           Proc [dbo].[sp_MailPhotobook_Hon1]
as
	...
	'<map name="Map"><area shape="poly" coords="1,392,296,391,297,565,762,562,763,3,3,2" href="http://www.photopie.co.kr/display/prod_list.asp?prod_cate=HNM&src=image&kw=00000A" target="_blank" onfocus="blur()"><area shape="rect" coords="77,400,261,468" href="http://www.photopie.co.kr/?src=image&kw=00000B" target="_blank" onfocus="blur()"></map></tr><tr>'+
	...
	' <map name="Map2"><area shape="poly" coords="387,759,761,755,757,2,22,4,21,449,385,445" href="http://www.photopie.co.kr/display/prod_list.asp?prod_cate=HNM&src=image&kw=00000A" target="_blank" onfocus="blur()">'+
