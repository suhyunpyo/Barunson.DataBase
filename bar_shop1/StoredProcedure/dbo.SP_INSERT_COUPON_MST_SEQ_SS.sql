IF OBJECT_ID (N'dbo.SP_INSERT_COUPON_MST_SEQ_SS', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_INSERT_COUPON_MST_SEQ_SS
GO
...
CREATE PROCEDURE [dbo].[SP_INSERT_COUPON_MST_SEQ_SS]
