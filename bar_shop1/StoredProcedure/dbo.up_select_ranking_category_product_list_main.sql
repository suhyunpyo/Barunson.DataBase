IF OBJECT_ID (N'dbo.up_select_ranking_category_product_list_main', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_ranking_category_product_list_main
GO
...
CREATE PROCEDURE [dbo].[up_select_ranking_category_product_list_main]
