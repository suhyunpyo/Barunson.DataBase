IF OBJECT_ID (N'dbo.up_Select_UserReview_List_SR', N'P') IS NOT NULL DROP PROCEDURE dbo.up_Select_UserReview_List_SR
GO
...
/*  
 ...
 exec up_Select_UserReview_List 5007, 36657, 1, 10, 1, NULL, NULL  
*/  
-- =============================================  
CREATE PROCEDURE [dbo].[up_Select_UserReview_List_SR]  
