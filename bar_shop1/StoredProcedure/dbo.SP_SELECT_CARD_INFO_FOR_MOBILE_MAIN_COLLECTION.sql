IF OBJECT_ID (N'dbo.SP_SELECT_CARD_INFO_FOR_MOBILE_MAIN_COLLECTION', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_CARD_INFO_FOR_MOBILE_MAIN_COLLECTION
GO
...
CREATE PROC [dbo].[SP_SELECT_CARD_INFO_FOR_MOBILE_MAIN_COLLECTION]  
