IF OBJECT_ID (N'dbo.SP_REPORT_SIGN_UP_AND_USER_INFORMATION_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_SIGN_UP_AND_USER_INFORMATION_TEST
GO
...
CREATE PROCEDURE [dbo].[SP_REPORT_SIGN_UP_AND_USER_INFORMATION_TEST]  
