IF OBJECT_ID (N'dbo.SP_SELECT_S2_CARD_WITH_ERP_STOCK_DEARDEER', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_S2_CARD_WITH_ERP_STOCK_DEARDEER
GO
...
EXEC SP_SELECT_S2_CARD_WITH_ERP_STOCK 0, 99999, 0, '', '', '정상판매|단종예정|발주대기|폐기대상|폐기|공백', '', '5001|5006|5007|5003|5008|5000', '', 'N', 9999, 1, 'REG_DATE', 'DESC'

*/
CREATE PROCEDURE [dbo].[SP_SELECT_S2_CARD_WITH_ERP_STOCK_DEARDEER]
