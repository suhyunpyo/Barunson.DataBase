IF OBJECT_ID (N'dbo.up_Select_S4_EventMusic_Reply', N'P') IS NOT NULL DROP PROCEDURE dbo.up_Select_S4_EventMusic_Reply
GO
...
*/
CREATE proc [dbo].[up_Select_S4_EventMusic_Reply]
...
LEFT JOIN VIEW_USRINFO VU ON VU.UID = S2ER.UID AND (VU.COMPANY_SEQ IS NULL OR VU.COMPANY_SEQ = S2ER.COMPANY_SEQ)
