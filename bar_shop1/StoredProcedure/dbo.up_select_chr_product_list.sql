IF OBJECT_ID (N'dbo.up_select_chr_product_list', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_chr_product_list
GO
...
-- up_select_chr_product_list 5007, 1, 24, 400    
-- =============================================    
CREATE PROCEDURE [dbo].[up_select_chr_product_list]    
 ...
 */    
 ...
 (    
  ...
  WHERE 1 = 1         
    ...
    --AND E.CardImage_HSize = '210'     
    AND E.CardImage_Div = 'E'        
    AND J.CardKind_Seq = 17 --답례장/결혼답례카드    
 ) AS RESULT    
