IF OBJECT_ID (N'dbo.PROC_SAVE_GIFT_ORDER', N'P') IS NOT NULL DROP PROCEDURE dbo.PROC_SAVE_GIFT_ORDER
GO
...
GO
/****************************************************************************************************************
-- SP Name       : PROC_SAVE_GIFT_ORDER
-- Author        : 박혜림
-- Create date   : 2020-08-13
-- Description   : 답례품 주문정보 저장
-- Update History: 2020-10-28 (박혜림) - 답례품 ERP 연동 테이블 저장 로직 추가
-- Comment       :
****************************************************************************************************************/
CREATE PROCEDURE [dbo].[PROC_SAVE_GIFT_ORDER]
...
EXEC bar_shop1.dbo.PROC_SAVE_GIFT_ORDER
	   'I'				
	 , 's4guest'						
     , ''					
	 , 'AA'					
