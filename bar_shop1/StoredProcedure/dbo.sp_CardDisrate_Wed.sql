IF OBJECT_ID (N'dbo.sp_CardDisrate_Wed', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_CardDisrate_Wed
GO
...
GO
CREATE Procedure [dbo].[sp_CardDisrate_Wed]
	@card_group	char(1),
	@disrate_type	char(1),
	@card_kind	char(1),
	@company	int,
