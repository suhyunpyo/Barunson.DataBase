IF OBJECT_ID (N'dbo.sp_MailSend_delivery_confirm', N'P') IS NOT NULL DROP PROCEDURE dbo.sp_MailSend_delivery_confirm
GO
...
CREATE procedure [dbo].[sp_MailSend_delivery_confirm]
as
