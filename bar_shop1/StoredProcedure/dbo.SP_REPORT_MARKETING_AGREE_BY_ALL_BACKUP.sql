IF OBJECT_ID (N'dbo.SP_REPORT_MARKETING_AGREE_BY_ALL_BACKUP', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_MARKETING_AGREE_BY_ALL_BACKUP
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_REPORT_MARKETING_AGREE_BY_ALL_BACKUP]
...
BEGIN
	...
	FROM	(
				...
				SELECT	CASE 
					...
					,	SUM(CASE WHEN INTERGRATION_DATE >= @P_START_DATE + ' 00:00:00' AND INTERGRATION_DATE < CONVERT(VARCHAR(10), DATEADD(DAY, 1, @P_END_DATE), 120) + ' 00:00:00' AND ISNULL(SUT.MKT_CHK_FLAG, 'N') = 'Y' AND TP.THIRD_PARTY_SHINHAN = 1 THEN 1 ELSE 0 END) THIRD_PARTY_SHINHAN_COUNT
