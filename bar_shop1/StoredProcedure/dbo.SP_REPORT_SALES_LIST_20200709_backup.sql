IF OBJECT_ID (N'dbo.SP_REPORT_SALES_LIST_20200709_backup', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_SALES_LIST_20200709_backup
GO
...
CREATE PROCEDURE [dbo].[SP_REPORT_SALES_LIST_20200709_backup]
...
FROM (
	...
	FROM (
		SELECT MAX(ORDER_COUPON_SEQ) AS ORDER_COUPON_SEQ
			, MAX(COUPON_ISSUE_SEQ) AS COUPON_ISSUE_SEQ
			--, COUPON_ISSUE_SEQ
			, ORDER_SEQ
