IF OBJECT_ID (N'dbo.SP_MAIN_NOTICEPOPUP_MNG', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_MAIN_NOTICEPOPUP_MNG
GO
...
CREATE PROCEDURE [dbo].[SP_MAIN_NOTICEPOPUP_MNG]  
...
IF @INFOLW_GUBUN = 'PC'
	BEGIN
		...
		SELECT TOP 1 imgfile_path, link_url  from S4_MD_Choice 
			WHERE md_Seq = @MD_SEQ 
