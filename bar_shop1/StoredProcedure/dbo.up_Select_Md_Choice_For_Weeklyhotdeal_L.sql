IF OBJECT_ID (N'dbo.up_Select_Md_Choice_For_Weeklyhotdeal_L', N'P') IS NOT NULL DROP PROCEDURE dbo.up_Select_Md_Choice_For_Weeklyhotdeal_L
GO
...
-- =============================================
CREATE proc [dbo].[up_Select_Md_Choice_For_Weeklyhotdeal_L]
...
SELECT
	...
	, B.Card_Name
	, B.CardBrand
	, CardImage_FileName = (select distinct top 1 CardImage_FileName from S2_CardImage where Company_Seq = C.Company_Seq and ((CardImage_WSize = '130' and CardImage_HSize = '130') or (CardImage_WSize = '180' and CardImage_HSize = '180')) and card_seq = A.card_seq)
	--, B.CardSet_Price
