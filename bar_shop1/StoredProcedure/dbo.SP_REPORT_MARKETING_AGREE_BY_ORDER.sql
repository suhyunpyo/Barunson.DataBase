IF OBJECT_ID (N'dbo.SP_REPORT_MARKETING_AGREE_BY_ORDER', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_REPORT_MARKETING_AGREE_BY_ORDER
GO
...
[SP_REPORT_MARKETING_AGREE_BY_ORDER_NAM] '2020-05-01','2020-05-31'

[SP_REPORT_MARKETING_AGREE_BY_ORDER] '2020-05-01','2020-05-31'
...
CREATE PROCEDURE [dbo].[SP_REPORT_MARKETING_AGREE_BY_ORDER]  
...
(  
  ...
  from 
	  ...
	  (  
	   ...
	   where (ema.gubun is null OR ema.gubun = 'C')
		and ema.uid is not null
        and ui.smembership_reg_date  >= @P_START_DATE + ' 00:00:00' and ui.smembership_reg_date  <= @P_END_DATE + ' 23:59:59'
		and ema.created_tmstmp  >= @P_START_DATE + ' 00:00:00' and ema.created_tmstmp  <= @P_END_DATE + ' 23:59:59' and 
		ui.chk_smembership = 'Y'

		-- and ui.smembership_leave_date is null
	  ...
	  (
	   ...
	   where (ema.gubun is null OR ema.gubun = 'C')
 		and ema.uid is not null
          and ui.iloommembership_reg_date  >= @P_START_DATE + ' 00:00:00' and ui.iloommembership_reg_date  <= @P_END_DATE + ' 23:59:59'
	   group by a.sales_Gubun  
	  ...
	  (
	   ...
	   where (ema.gubun is null OR ema.gubun = 'C')
		and ema.uid is not null
		and ema.created_tmstmp >= @P_START_DATE + ' 00:00:00' and ema.created_tmstmp <= @P_END_DATE + ' 23:59:59'
	   group by a.sales_Gubun  
		 --------------------------------------------------------------------------------------------------------------------
	  ...
	  (  
	   ...
	   where (ema.gubun is null OR ema.gubun = 'C')
		and ema.uid is not null
        and ui.lgmembership_reg_date  >= @P_START_DATE + ' 00:00:00' and ui.lgmembership_reg_date  <= @P_END_DATE + ' 23:59:59' 
		and ema.created_tmstmp  >= @P_START_DATE + ' 00:00:00' and ema.created_tmstmp  <= @P_END_DATE + ' 23:59:59'
		-- and ui.lgmembership_leave_date is null
	   group by a.sales_Gubun  
		 --------------------------------------------------------------------------------------------------------------------
