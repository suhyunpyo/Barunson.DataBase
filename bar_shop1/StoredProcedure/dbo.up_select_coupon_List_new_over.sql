IF OBJECT_ID (N'dbo.up_select_coupon_List_new_over', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_coupon_List_new_over
GO
...
-- Description:	중복쿠폰 리스트 
-- EXEC up_select_coupon_List_new_over 5007, 's5guest', 2, 'N'
-- =============================================

CREATE PROCEDURE [dbo].[up_select_coupon_List_new_over]
