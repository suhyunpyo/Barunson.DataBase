IF OBJECT_ID (N'dbo.SP_SELECT_NONMEMBER_LOGIN', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_NONMEMBER_LOGIN
GO
...
*/
CREATE PROCEDURE [dbo].[SP_SELECT_NONMEMBER_LOGIN]
