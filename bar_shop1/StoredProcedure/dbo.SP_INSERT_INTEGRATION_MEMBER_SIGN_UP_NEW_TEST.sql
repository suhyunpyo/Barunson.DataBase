IF OBJECT_ID (N'dbo.SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_NEW_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_NEW_TEST
GO
...
GO
CREATE PROC [dbo].[SP_INSERT_INTEGRATION_MEMBER_SIGN_UP_NEW_TEST] 
