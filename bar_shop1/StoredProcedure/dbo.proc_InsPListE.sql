IF OBJECT_ID (N'dbo.proc_InsPListE', N'P') IS NOT NULL DROP PROCEDURE dbo.proc_InsPListE
GO
...
GO
CREATE    Procedure [dbo].[proc_InsPListE]	
	@order_seq int,	
	@title varchar(50),	
	@card_seq int,	
	@ptype char(1),	
	...
	begin	
		...
		,isZipBox,recv_tail) values(@order_seq,@ptype,@card_seq,@title,@pcount,@isNotPrint
		,@env_person1,@env_person2,@env_person_tail,@env_person1_tail,@env_person2_tail,@isenv_person_tail
