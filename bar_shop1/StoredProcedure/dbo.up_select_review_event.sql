IF OBJECT_ID (N'dbo.up_select_review_event', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_review_event
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[up_select_review_event]
...
BEGIN
	...
	if @txt_card_seq = 0
		begin
			if (@company_seq = '5001' or @company_seq = '5003' or @company_seq = '5007' or @company_seq = '5006')	--바른손
				begin
