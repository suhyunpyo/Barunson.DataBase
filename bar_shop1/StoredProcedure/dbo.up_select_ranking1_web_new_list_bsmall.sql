IF OBJECT_ID (N'dbo.up_select_ranking1_web_new_list_bsmall', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_ranking1_web_new_list_bsmall
GO
...
GO
-- =============================================
-- up_select_ranking1_web_new_list_bsmall

-- =============================================
create PROCEDURE [dbo].[up_select_ranking1_web_new_list_bsmall]
...
BEGIN
	...
	if @jehyu = '1'
		begin
            ...
            -- 비핸즈카드 전용 디지털카드를 위한 쿼리(제휴:바른손몰 company_seq : 5000로 변경)
            LEFT JOIN   (
                            SELECT  SMC.CARD_SEQ, 5000 AS COMPANY_SEQ
