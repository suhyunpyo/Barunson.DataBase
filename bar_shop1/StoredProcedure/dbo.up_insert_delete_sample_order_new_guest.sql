IF OBJECT_ID (N'dbo.up_insert_delete_sample_order_new_guest', N'P') IS NOT NULL DROP PROCEDURE dbo.up_insert_delete_sample_order_new_guest
GO
...
-- 웨딩일 추가
-- =============================================
CREATE PROCEDURE [dbo].[up_insert_delete_sample_order_new_guest]
