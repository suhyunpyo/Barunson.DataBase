IF OBJECT_ID (N'dbo.up_select_wish_list_boton', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_wish_list_boton
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[up_select_wish_list_boton]
