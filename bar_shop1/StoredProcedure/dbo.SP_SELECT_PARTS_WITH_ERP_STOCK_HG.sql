IF OBJECT_ID (N'dbo.SP_SELECT_PARTS_WITH_ERP_STOCK_HG', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_PARTS_WITH_ERP_STOCK_HG
GO
...
CREATE PROCEDURE [dbo].[SP_SELECT_PARTS_WITH_ERP_STOCK_HG]
