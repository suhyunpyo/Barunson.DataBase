IF OBJECT_ID (N'dbo.up_select_messagecard_product_list', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_messagecard_product_list
GO
...
-- Description:	THE CARD 메시지카드 LIST
-- up_select_messagecard_product_list 5007, 1, 24, 400
-- =============================================
CREATE PROCEDURE [dbo].[up_select_messagecard_product_list]
