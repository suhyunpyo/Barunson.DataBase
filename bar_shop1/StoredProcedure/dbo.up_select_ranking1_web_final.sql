IF OBJECT_ID (N'dbo.up_select_ranking1_web_final', N'P') IS NOT NULL DROP PROCEDURE dbo.up_select_ranking1_web_final
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[up_select_ranking1_web_final]
...
BEGIN
	...
	IF @company_seq IS NULL or @company_seq=''
		begin
			...
			select @data_arry=ST_Card_Code_Arry, @data_arry_title=ST_Title from S4_Ranking_Sort where ST_company_seq=@company_seq and ST_SEQ=@code ;
