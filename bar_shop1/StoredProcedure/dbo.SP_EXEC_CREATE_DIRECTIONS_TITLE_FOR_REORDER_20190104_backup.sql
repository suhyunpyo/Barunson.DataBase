IF OBJECT_ID (N'dbo.SP_EXEC_CREATE_DIRECTIONS_TITLE_FOR_REORDER_20190104_backup', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_EXEC_CREATE_DIRECTIONS_TITLE_FOR_REORDER_20190104_backup
GO
...
*/
CREATE PROCEDURE [dbo].[SP_EXEC_CREATE_DIRECTIONS_TITLE_FOR_REORDER_20190104_backup]
    @TITLE AS VARCHAR(20)
,   @ORDER_SEQ AS INT
AS
BEGIN
