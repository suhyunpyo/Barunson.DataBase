IF OBJECT_ID (N'dbo.SP_ADMIN_SELECT_ORDER_MST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_ADMIN_SELECT_ORDER_MST
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_ADMIN_SELECT_ORDER_MST]
...
BEGIN
    ...
    SET @r_total_count = (
							...
							WHERE 
							VOM.ORDER_TYPE_CODE = '110001'
							AND
							(
								CASE @p_search_type
								WHEN 'code' THEN VOM.ORDER_CODE
								WHEN 'id' THEN VOM.USER_ID + VOM.FIRST_NAME +  VOM.LAST_NAME
