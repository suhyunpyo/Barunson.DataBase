IF OBJECT_ID (N'dbo.SP_ADMIN_UPDATE_BANNER_SORT_TO_DOWN', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_ADMIN_UPDATE_BANNER_SORT_TO_DOWN
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_ADMIN_UPDATE_BANNER_SORT_TO_DOWN]
	@p_banner_seq int
AS
BEGIN
	...
	SET @t_swap_sort_num = (SELECT MIN(SORT_NUM) FROM BANNER_MST WHERE BANNER_TYPE_CODE = @t_current_banner_type AND SORT_NUM > @t_current_sort);
