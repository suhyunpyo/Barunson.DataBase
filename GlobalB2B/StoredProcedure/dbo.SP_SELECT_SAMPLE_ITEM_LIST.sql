IF OBJECT_ID (N'dbo.SP_SELECT_SAMPLE_ITEM_LIST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_SELECT_SAMPLE_ITEM_LIST
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_SELECT_SAMPLE_ITEM_LIST]
