IF OBJECT_ID (N'dbo.SP_S_ADMIN_ORDER_LIST_TEST', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_S_ADMIN_ORDER_LIST_TEST
GO
...
GO
CREATE PROCEDURE [dbo].[SP_S_ADMIN_ORDER_LIST_TEST]
/*************************************************************** 
작성자	:	표수현
작성일	:	2021-05-26
