IF OBJECT_ID (N'dbo.SP_T_SERIAL_COUPON_APPLY_PRODUCT_INSERT', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_T_SERIAL_COUPON_APPLY_PRODUCT_INSERT
GO
...
GO
CREATE PROCEDURE [dbo].[SP_T_SERIAL_COUPON_APPLY_PRODUCT_INSERT]
/***************************************************************
작성자	:	송태정
작성일	:	2022-01-07
DESCRIPTION	: 시리얼어드민 - 쿠폰 적용 / 미적용할 상품 저장 / 삭제 
SPECIAL LOGIC	: SP_T_SERIAL_COUPON_APPLY_PRODUCT_INSERT 'I', 'MC1201'
******************************************************************
MODIFICATION
******************************************************************
수정일           작업자                DESCRIPTION
...
AS 
 ...
 IF @GUBUN = 'I' BEGIN  
	 ...
	 IF @PRODUCT_APPLY_ID = 0 OR @PRODUCT_APPLY_ID = NULL BEGIN 
		...
		INSERT TB_SERIAL_COUPON_APPLY_PRODUCT(COUPON_ID)
		VALUES(NULL)

		DECLARE @NEW_PRODUCT_APPLY_ID INT = @@IDENTITY

		INSERT TB_SERIAL_APPLY_PRODUCT(PRODUCT_APPLY_ID, PRODUCT_CODE)
 ...
 END ELSE BEGIN 
	...
	WHERE PRODUCT_APPLY_ID = @PRODUCT_APPLY_ID
		...
		IF @상품중복카운트 = 0 BEGIN 
			...
			DELETE 
			FROM TB_SERIAL_COUPON_APPLY_PRODUCT
			WHERE PRODUCT_APPLY_ID = @PRODUCT_APPLY_ID

			UPDATE TB_SERIAL_COUPON 
