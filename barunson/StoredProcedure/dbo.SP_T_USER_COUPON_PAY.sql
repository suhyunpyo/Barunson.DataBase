IF OBJECT_ID (N'dbo.SP_T_USER_COUPON_PAY', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_T_USER_COUPON_PAY
GO
...
GO
CREATE PROCEDURE [dbo].[SP_T_USER_COUPON_PAY]
/***************************************************************
작성자	:	표수현
작성일	:	2020-02-15
DESCRIPTION	:	쿠폰 전액 결재 처리 
SPECIAL LOGIC	:
******************************************************************
MODIFICATION
******************************************************************
