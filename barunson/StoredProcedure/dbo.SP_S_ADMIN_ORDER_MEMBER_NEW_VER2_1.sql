IF OBJECT_ID (N'dbo.SP_S_ADMIN_ORDER_MEMBER_NEW_VER2_1', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_S_ADMIN_ORDER_MEMBER_NEW_VER2_1
GO
...
CREATE PROCEDURE [dbo].[SP_S_ADMIN_ORDER_MEMBER_NEW_VER2_1]
/***************************************************************
작성자	:	표수현
작성일	:	2021-05-26
