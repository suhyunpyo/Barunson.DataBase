IF OBJECT_ID (N'dbo.SP_S_ADMIN_ORDER_LIST_EXCEL2', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_S_ADMIN_ORDER_LIST_EXCEL2
GO
...
GO
CREATE PROCEDURE [dbo].[SP_S_ADMIN_ORDER_LIST_EXCEL2]
/*************************************************************** 
작성자	:	표수현
작성일	:	2021-05-26
	...
	FROM (  
			SELECT 
					 회원모초구매횟수 = (
									...
									SELECT COUNT(1) 
									FROM TB_ORDER 
									WHERE USER_ID = T.[USER_ID] AND NAME = T.[NAME]
