IF OBJECT_ID (N'dbo.SP_S_BARUNSON.DBO.VW_USER_LOGIN', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_S_BARUNSON.DBO.VW_USER_LOGIN
GO
...
EXEC SP_SELECT_BARUNSON.DBO.VW_USER   _FOR_LOGIN 's4guest', 'ysmguest', ''
...
use barunson
*/
CREATE PROCEDURE [dbo].[SP_S_BARUNSON.DBO.VW_USER_LOGIN]
