IF OBJECT_ID (N'dbo.SP_S_ADMIN_ORDER_MEMBER_NEW_백업', N'P') IS NOT NULL DROP PROCEDURE dbo.SP_S_ADMIN_ORDER_MEMBER_NEW_백업
GO
...
GO
CREATE PROCEDURE [dbo].[SP_S_ADMIN_ORDER_MEMBER_NEW_백업]
/***************************************************************
작성자	:	표수현
작성일	:	2021-05-26
